<div class="form-group{{ $errors->has('equipment_number') ? ' has-error' : '' }}">
    ...
    {!! Form::text('equipment_number', old('equipment_number', $hall->equipment_number), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.equipment_number')]) !!}
...
<div class="form-group{{ $errors->has("equipment_name") ? ' has-error' : '' }}">
    ...
    {!! Form::text("equipment_name", old('equipment_name',$hall->equipment_name), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.equipment_name')]) !!}
...
<div class="form-group{{ $errors->has("location") ? ' has-error' : '' }}">
    ...
    {!! Form::text("location", old('location', $hall->location), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.location')]) !!}
    {!! $errors->first("location", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("serial_number") ? ' has-error' : '' }}">
    {!! Form::label("serial_number", trans('base::halls.form.serial_number')) !!}
    {!! Form::text("serial_number", old('serial_number', $hall->serial_number), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.serial_number')]) !!}
...
<div class="form-group{{ $errors->has("producer") ? ' has-error' : '' }}">
    ...
    {!! Form::text("producer", old('producer', $hall->producer), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.producer')]) !!}
...
<div class="form-group{{ $errors->has("manuf_year") ? ' has-error' : '' }}">
    ...
    {!! Form::date("manuf_year", old('manuf_year', $hall->manuf_year), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.manuf_year')]) !!}
...
<div class="form-group{{ $errors->has("commissioning") ? ' has-error' : '' }}">
    ...
    {!! Form::date("commissioning", old('commissioning', $hall->commissioning), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.commissioning')]) !!}
...
<div class="form-group{{ $errors->has("sap_inven_number") ? ' has-error' : '' }}">
    ...
    {!! Form::date("sap_inven_number", old('sap_inven_number', $hall->sap_inven_number), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.sap_inven_number')]) !!}
    {!! $errors->first("sap_inven_number", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("type") ? ' has-error' : '' }}">
    {!! Form::label("type", trans('base::halls.form.type')) !!}
    {!! Form::text("type", old('type', $hall->type), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.type')]) !!}
    {!! $errors->first("type", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("position") ? ' has-error' : '' }}">
    {!! Form::label("position", trans('base::halls.form.position')) !!}
    {!! Form::number("position", old("position", $hall->position), ['class' => 'form-control', 'placeholder' => trans('base::halls.form.position')]) !!}
    {!! $errors->first("position", '<span class="help-block">:message</span>') !!}
</div>
{!! Form::normalTextarea('note', trans('base::halls.form.note'), $errors, $hall) !!}
