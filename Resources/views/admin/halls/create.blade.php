...
<h1>
    {{ trans('base::halls.titles.create hall item') }}
</h1>
<ol class="breadcrumb">
    <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
    <li><a href="{{ route('admin.base.hall.index') }}">{{ trans('base::halls.title.halls') }}</a></li>
    <li>{{ trans('base::halls.breadcrumb.create item') }}</li>
</ol>
@stop

@section('content')
{!! Form::open(['route' => ['admin.base.hall.store'], 'method' => 'post']) !!}
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                @include('base::admin.halls.partials.create-fields')
            </div>
        </div>
