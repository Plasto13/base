<div class="form-group{{ $errors->has("equipment_number") ? ' has-error' : '' }}">
    ...
    {!! Form::text("equipment_number", old("equipment_number"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.equipment_number')]) !!}
...
<div class="form-group{{ $errors->has("equipment_name") ? ' has-error' : '' }}">
    ...
    {!! Form::text("equipment_name", old("equipment_name"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.equipment_name')]) !!}
...
<div class="form-group{{ $errors->has("location") ? ' has-error' : '' }}">
    ...
    {!! Form::text("location", old("location"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.location')]) !!}
    {!! $errors->first("location", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("serial_number") ? ' has-error' : '' }}">
    {!! Form::label("serial_number", trans('base::lines.form.serial_number')) !!}
    {!! Form::text("serial_number", old("serial_number"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.serial_number')]) !!}
...
<div class="form-group{{ $errors->has("producer") ? ' has-error' : '' }}">
    ...
    {!! Form::text("producer", old("producer"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.producer')]) !!}
...
<div class="form-group{{ $errors->has("manuf_year") ? ' has-error' : '' }}">
    ...
    {!! Form::date("manuf_year", old("manuf_year"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.manuf_year')]) !!}
...
<div class="form-group{{ $errors->has("commissioning") ? ' has-error' : '' }}">
    ...
    {!! Form::date("commissioning", old("commissioning"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.commissioning')]) !!}
...
<div class="form-group{{ $errors->has("sap_inven_number") ? ' has-error' : '' }}">
    ...
    {!! Form::date("sap_inven_number", old("sap_inven_number"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.sap_inven_number')]) !!}
    {!! $errors->first("sap_inven_number", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("type") ? ' has-error' : '' }}">
    {!! Form::label("type", trans('base::lines.form.type')) !!}
    {!! Form::text("type", old("type"), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.type')]) !!}
    {!! $errors->first("type", '<span class="help-block">:message</span>') !!}
</div>
<div class="form-group{{ $errors->has("position") ? ' has-error' : '' }}">
    {!! Form::label("position", trans('base::lines.form.position')) !!}
    {!! Form::number("position", old('position', 0), ['class' => 'form-control', 'placeholder' => trans('base::lines.form.position')]) !!}
    {!! $errors->first("position", '<span class="help-block">:message</span>') !!}
</div>
{!! Form::normalTextarea('note', trans('base::lines.form.note'), $errors) !!}
